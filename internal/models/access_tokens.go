...
var (
	accessTokenAllColumns            = []string{"token", "user_id", "valid_until", "created_at", "updated_at"}
	accessTokenColumnsWithoutDefault = []string{"user_id", "valid_until", "updated_at"}
	accessTokenColumnsWithDefault    = []string{"token", "created_at"}
...
// OneG returns a single accessToken record from the query using the global executor.
func (q accessTokenQuery) OneG(ctx context.Context) (*AccessToken, error) {
...
// AllG returns all AccessToken records from the query using the global executor.
func (q accessTokenQuery) AllG(ctx context.Context) (AccessTokenSlice, error) {
...
// CountG returns the count of all AccessToken records in the query using the global executor
func (q accessTokenQuery) CountG(ctx context.Context) (int64, error) {
...
func (q accessTokenQuery) ExistsG(ctx context.Context) (bool, error) {
...
// SetUserG of the accessToken to the related item.
// Sets o.R.User to related.
// Adds o to related.R.AccessTokens.
// Uses the global database handle.
func (o *AccessToken) SetUserG(ctx context.Context, insert bool, related *User) error {
...
// FindAccessTokenG retrieves a single record by ID.
func FindAccessTokenG(ctx context.Context, token string, selectCols ...string) (*AccessToken, error) {
	return FindAccessToken(ctx, boil.GetContextDB(), token, selectCols...)
}
...
func (o *AccessToken) InsertG(ctx context.Context, columns boil.Columns) error {
...
// UpdateG a single AccessToken record using the global executor.
// See Update for more documentation.
func (o *AccessToken) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q accessTokenQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o AccessTokenSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *AccessToken) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
// DeleteG deletes a single AccessToken record.
// DeleteG will match against the primary key column to find the record to delete.
func (o *AccessToken) DeleteG(ctx context.Context) (int64, error) {
...
func (q accessTokenQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o AccessTokenSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *AccessToken) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no AccessToken provided for reload")
	}
...
func (o *AccessTokenSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty AccessTokenSlice provided for reload all")
	}
...
// AccessTokenExistsG checks if the AccessToken row exists.
func AccessTokenExistsG(ctx context.Context, token string) (bool, error) {
	return AccessTokenExists(ctx, boil.GetContextDB(), token)
}
