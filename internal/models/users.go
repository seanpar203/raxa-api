...
var (
	userAllColumns            = []string{"id", "email", "password", "is_active", "last_authenticated_at", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"is_active", "created_at", "updated_at"}
	userColumnsWithDefault    = []string{"id", "email", "password", "last_authenticated_at"}
